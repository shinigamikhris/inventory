...
function confirmation(){
	return confirm('Are you sure you want ot delete record???');
}
</script>
...
<header id="header">
  <div class="container">
    <div class="row">
      <div class="col-md-10">
        <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Bitz4Bikes <small>Supplier</small></h1>
      </div>
      <div class="col-md-2">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-3">
          ...
          <a href="supplier.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-th-list"></span> Supplier</a>
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
              <h3 class="panel-title">Supplier's Overview
                <?php include('supplier_add_modal.php'); ?>
              </h3>
              <br>
            </div>
...
echo "<td><a href='supplier_edit.php?ID=".$query2['SupplierID']."'><span class='glyphicon glyphicon-edit' aria-hidden='true'></span> </a>";
echo "<a href='supplier_delete.php?ID=".$query2['SupplierID']."' onclick='return confirmation()'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a></td>";
 echo "</tr>";
}
?>
            </div>
...
<div class="modal fade" id="Addloss" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
