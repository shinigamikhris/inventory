        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
              <h3 class="panel-title">Manufacturer Overview
                <?php include('manufacturer_add_modal.php'); ?>
              </h3>
              <br>
            </div>
...
<?php 
$query1=mysql_query("select * from manufacturer");    

while($query2=mysql_fetch_array($query1))
{
echo "<td>".$query2['brand']."</td>";  

echo "<td><img src=customization/manufacturer/".$query2['file']." style='width:110px; height:110px' /></td>";

echo "<td><a href='motorcycle_edit.php?ID=".$query2['manufacturer_id']."'><span class='glyphicon glyphicon-cog gi-3x' aria-hidden='true'></span> </a>";
echo "<a href='motorcycle_delete.php?ID=".$query2['manufacturer_id']."' onclick='return confirmation()'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a></td>";
 echo "</tr>";
}
?>
            </div>
