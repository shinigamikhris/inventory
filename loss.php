    ...
    <div class="container">
      <div class="row">
        <div class="col-md-3">
          ...
          <a href="loss.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-eye-close"></span> Loss Items</a>
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
              <h3 class="panel-title">LOSS ITEM Overview
              <a href="loss_view.php" class="btn btn-primary btn-sm" style="float: right;"><span class="glyphicon glyphicon-eye-open"></span> VIEW ITEM LOSS</a>
...
echo "<td><a href='loss_add_modal.php?ID=".$query2['ProductID']."'><button type=;button' class='btn btn-info'> ADD</a></td><tr>";
}
?>
            </div>
          </div>
